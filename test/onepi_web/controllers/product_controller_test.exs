defmodule OnepiWeb.ProductControllerTest do
  use OnepiWeb.ConnCase

  alias Onepi.Products

  @create_attrs %{blockchain_id: "some blockchain_id", colour: "some colour", image: "some image", name: "some name", picode: "some picode"}
  ...
  describe "update product" do
    ...
    test "redirects when data is valid", %{conn: conn, product: product} do
      ...
      assert html_response(conn, 200) =~ "some updated blockchain_id"
    end
